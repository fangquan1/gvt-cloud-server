...
TAP_IF=tap-win10
BR_IF=br0
VM_DISK=/root/qemu_cmd/multivm/win10-vm1-active.qcow2
...
nohup "$QEMU_BIN" \
  ...
  -device vfio-pci-nohotplug,sysfsdev=/sys/bus/pci/devices/0000:00:02.0/e582c6f5-e5cd-4a8e-9443-55a013e9f193,display=on,x-igd-opregion=on,ramfb=on \
  -hda "$VM_DISK" \
